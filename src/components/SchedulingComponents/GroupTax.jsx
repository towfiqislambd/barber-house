          ...
          <div className="flex flex-col gap-[32px]">
            <div className="">
              ...
              <input
                ...
                className="sm:py-[16px] py-3 px-[20px] border rounded-[8px] w-full focus:border-[#00B1B9] focus:outline-none"
              />
            </div>
            <div className="">
              <label
              ...
              <div className="relative">
                <input
                  ...
                  className="sm:py-[16px] py-3 px-[20px] border rounded-[8px] w-full focus:border-[#00B1B9] focus:outline-none pl-[40px]"
                />
