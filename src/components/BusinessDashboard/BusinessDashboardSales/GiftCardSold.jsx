    ...
    <div>
      ...
      <div className="flex justify-between items-center gap-5 flex-wrap">
        ...
        <div className="flex gap-3 items-center">
          ...
          <Popover>
            <PopoverTrigger>
              <button className="px-2 lg:px-4 py-1 lg:py-[10px] flex gap-2 items-center outline-none rounded-lg border border-primary">
                <ExportSvg />
                <p>Options</p>
                <DropdownSvg />
              </button>
      ...
      <div className="border-t border-borderColorLight mt-10 pb-5"></div>
      <div className="overflow-x-auto">
        ...
        <table className="w-full border-collapse lg:min-w-[800px]">
          <tr className="lg:text-lg text-gray-700 text-nowrap">
            ...
            <th className="px-2 lg:px-4 text-left py-3 lg:py-6">
              Purchase date
            </th>
          ...
          <tbody>
            {tableData.map(data => (
              <tr
                key={data.id}
                className="hover:bg-gray-200 text-nowrap border-t 
                    first:border-none border-dashed text-[#545454]"
              >
                <td className="lg:px-4  px-2 text-[#545454] font-medium py-3 lg:py-5">
                  {data.name}
                </td>
                <td className="lg:px-4  px-2 text-[#545454] font-medium py-3 lg:py-5 text-left">
                  {data.client}
                </td>
                <td className="lg:px-4  px-2 text-[#545454] font-medium py-3 lg:py-5 text-left">
                  {data.client}
