...
const MembershipSold = () => {
  return (
    <div>
      <h3 className="text-[#2C2C2C] text-xl font-outfit lg:text-2xl font-medium mb-2">
        Memberships sold
      </h3>
      ...
      <div className="flex justify-between items-center flex-wrap gap-5">
        <div className="flex gap-5 items-center flex-wrap">
          ...
          <div className="relative w-[300px] lg:w-[350px] 4xl:w-[450px]">
            <input
              type="text"
              className="rounded-full bg-white w-full py-2 lg:py-3 px-5 shadow outline-none lg:border border-gray-100"
        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            {tableData.map(data => (
              ...
              >
                <td className="px-2 lg:px-4 text-[#545454] font-medium py-5">
                  {data.name}
                </td>
                <td className="px-2 lg:px-4 text-[#545454] font-medium py-5 text-left">
                  {data.client}
                </td>
                <td className="px-2 lg:px-4 text-[#545454] font-medium py-5 text-left">
                  {data.type}
                ...
                <td className="px-2 lg:px-4 font-medium py-5 text-left">
                  <button
                    ...
                    } px-2 lg:px-3 py-1 border rounded-full`}
                  >
                    {data.status}
                  </button>
                </td>
