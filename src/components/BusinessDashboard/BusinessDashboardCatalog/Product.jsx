        ...
        <div>
            {
                isMember ?
                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex gap-5 items-center">
                                ...
                                <div className="relative w-[450px]">
                                    <input type="text" className="rounded-full bg-white w-full py-3 px-5 shadow outline-none border border-gray-100" placeholder="Search by membership name" />
                                    <button className="absolute right-2 top-2 w-9 h-9 bg-black grid place-items-center rounded-full"><AppointmentsSearchSvg /></button>
                                </div>
                                {/* Filter */}
                                <MembershipModal />
                    ...
                    first:border-none border-dashed text-[#545454]">
                                        ...
                                        <td className="px-4 text-[#545454] font-medium py-5">{data.validFor}</td>
                                        <td className="px-4 text-[#545454] font-medium py-5">{data.seasons}</td>
                                        <td className="px-4 text-[#545454] font-medium py-5">{data.price}</td>
                                    </tr>)
                                }
                            </tbody>
                        </table>
                    ...
                    <div className="flex gap-10">
                        <div className="">
                            ...
                            <h3 className="text-[#2C2C2C] max-w-[483px] font-outfit text-2xl xl:text-3xl 2xl:text-4xl font-semibold mb-5">Manage your inventory with Fresha product list</h3>
                            <p className="lg:text-lg font-medium max-w-[483px] text-[#545454] mb-3 lg:mb-5">Manage your inventory and stock levels for easy ordering, tracking and selling:</p>
                            ...
                            <div className="flex items-center gap-2">
                                <Link to='/businessDashboard/addnew-product'>
                                    <button className="text-white bg-[#008A90] font-medium px-4 lg:px-7 rounded-lg py-2 lg:py-3">Start now</button>
                                </Link>
                            </div>
                        </div>
