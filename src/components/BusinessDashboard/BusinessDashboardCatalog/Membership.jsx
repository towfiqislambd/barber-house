    ...
    <div>
      {isMember ? (
        <div className="">
          ...
          <div className="flex justify-between items-center gap-5 flex-wrap">
            ...
            <div className="flex gap-2 lg:gap-3 items-center">
              ...
              <Popover>
                <PopoverTrigger>
                  <button className="px-2 lg:px-4 py-[5px] lg:py-[10px] flex gap-2 items-center outline-none rounded-lg border border-primary">
                    <ExportSvg />
                    <p>Options</p>
                    <DropdownSvg />
                  </button>
          ...
          <div className="overflow-x-auto">
            ...
            <table className="w-full border-collapse lg:min-w-[800px]">
              <tr className="lg:text-lg text-nowrap text-gray-700">
                <th className="px-2 lg:px-4 py-3 lg:py-6 text-left">
                  Membership name
                </th>
                <th className="px-2 lg:px-4 py-3 lg:py-6 text-left">
                  Valid for
                ...
                {tableData.map(data => (
                  ...
                  >
                    <td className="px-4 text-[#545454] font-medium py-5 flex gap-2 items-center">
                      <div className="bg-primary-gradient p-2 lg:p-4 rounded-lg">
                        {data?.membership?.image}
                      </div>
                      <div className="">
                        <h3 className="lg:text-[17px] font-medium text-[#2C2C2C]">
                          {data.membership.name}
                        </h3>
                        <h3>{data.membership.service}</h3>
                      </div>
                    </td>
                    <td className="px-2 lg:px-4 py-2 text-sm lg:text-base lg:text-[#545454] font-medium lg:py-6">
                      {data.validFor}
                    </td>
                    <td className="px-2 lg:px-4 py-2 text-sm lg:text-base lg:text-[#545454] font-medium lg:py-6">
                      {data.seasons}
        ...
        <div className="flex gap-10">
          <div className="">
            <p className="text-[#008C4F] px-3 py-1 inline-block font-medium rounded-full bg-[#DCFEE6] border mb-4 border-[#00C2CB]">
              Free to use
            </p>
            <h3 className="text-[#2C2C2C] max-w-[483px] font-outfit text-4xl font-semibold mb-5">
              Manage multi-session memberships
            </h3>
            <p className="text-lg font-medium max-w-[483px] text-[#545454] mb-5">
            ...
            <ul className="text-[#2C2C2C] space-y-4 mb-10 font-medium">
              ...
              <li className="flex gap-2 items-center">
                <MembershipCheckSvg />
                <p>
                  Clients can easily book and keep track of their remaining
                  sessions
                </p>
              </li>
            </ul>
            <div className="flex items-center gap-2">
              <Link to="/businessDashboard/membership-creation">
                <button className="text-white bg-[#008A90] font-medium px-7 rounded-lg py-3">
                  Start now
                </button>
              </Link>
            </div>
