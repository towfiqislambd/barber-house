        ...
        <div className="space-y-8">
            {
                <div>
                    ...
                    <div className="space-y-4">
                        {
                            categoryData[0].info.map((infoData, idx) => <div key={idx} className="bg-white rounded-xl border-l-[5px] border-[#8AE3E7] py-5 3xl:py-8 3xl:px-5 px-3 shadow-[0px_0px_4px_0px_rgba(4,0,116,0.10)] flex justify-between items-center">
                                <div className="">
