...
const ClientModal = () => {
  return (
    <Dialog>
      <DialogTrigger>
        <button className="flex gap-2 border-gray-100 bg-white items-center 3xl:py-3 py-2 px-4 rounded-full border shadow">
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <div className="flex items-center justify-between mt-5">
              <p className="text-primary cursor-pointer text-lg font-medium">
                Clear all filters
              </p>
              <div className="flex gap-3 justify-end mt-7">
                ...
                <button className="px-4 py-2 bg-primary text-white rounded-lg border border-borderColor font-medium">
                  Apply
                </button>
              </div>
            </div>
