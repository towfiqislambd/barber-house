                ...
                <DialogHeader>
                    ...
                    <DialogDescription>
                        <div className="space-y-6">
                            ...
                            <div>
                                <h3 className="mb-2 text-base font-semibold text-[#2C2C2C]">Type</h3>
                                <Select>
                                    <SelectTrigger className="w-full text-base border !py-5 border-[#B3BAC5]">
                            ...
                            <div>
                                <h3 className="mb-2 text-base font-semibold text-[#2C2C2C]">Online bookings</h3>
                                <Select>
                                    <SelectTrigger className="w-full text-base border !py-5 border-[#B3BAC5]">
                                        <SelectValue placeholder="All statuses" />
                                    </SelectTrigger>
                            ...
                            <div>
                                <h3 className="mb-2 text-base font-semibold text-[#2C2C2C]">Commissions</h3>
                                <Select>
                                    <SelectTrigger className="w-full text-base border !py-5 border-[#B3BAC5]">
                                        <SelectValue placeholder="All statuses" />
                                    </SelectTrigger>
