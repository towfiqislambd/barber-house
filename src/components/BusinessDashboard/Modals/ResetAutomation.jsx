...
const ResetAutomation = () => {
  return (
    <Dialog>
      <DialogTrigger>
        <button className="">
          <p className="text-[#D21837] font-medium">Reset</p>
        </button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader className="md:pr-[25px] md:pl-[20px] md:py-[30px]">
          <DialogTitle className="mb-3 text-xl">Reset automation</DialogTitle>
          <p className="text-textLight font-manrope text-base font-medium leading-6">
            Are you sure you want to reset this automation? This action will
            restore the default values, and it can not be undone.
          </p>
          <DialogDescription>
            <div className="flex flex-col md:flex-row gap-3 md:justify-center mt-7">
