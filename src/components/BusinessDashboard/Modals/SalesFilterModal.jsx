                ...
                <DialogHeader>
                    ...
                    <DialogDescription>
                        <div className="space-y-6">
                            <div>
                                <h3 className="mb-2 text-base font-semibold text-[#2C2C2C]">Status</h3>
                                <Select>
                            ...
                            <div className="flex gap-5 items-center">
                                <div className="flex-1">
                                    <h3 className="mb-2 text-base font-semibold text-[#2C2C2C]">From amount</h3>
                                    <div className="relative">
                                        <p className="absolute text-base top-3 left-3 font-semibold text-[#545454]">BDT</p>
                                        <input type="text" className="w-full ps-12 pe-3 py-[10px] border rounded outline-none text-base border-[#97A0AF]" placeholder="From" />
                                    </div>
                                </div>
                                <div className="flex-1">
                                    <h3 className="mb-2 text-base font-semibold text-[#2C2C2C]">To amount</h3>
                                    <div className="relative">
                                        <p className="absolute text-base top-3 left-3 font-semibold text-[#545454]">BDT</p>
                                        <input type="text" className="w-full ps-12 pe-3 py-[10px] border rounded outline-none text-base border-[#97A0AF]" placeholder="To" />
                                    </div>
                                </div>
                            </div>
                            <div>
                                <h3 className="mb-2 text-base font-semibold text-[#2C2C2C]">Including items</h3>
                                <Select>
                                    <SelectTrigger className="w-full text-base border !py-5 border-[#B3BAC5]">
                        ...
                        <div className="flex gap-3 justify-end mt-7">
                            <button className="px-4 py-[5px] rounded-lg border border-[#00C2CB] font-medium text-[#2C2C2C]">Clear All</button>
