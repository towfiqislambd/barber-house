  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-16 gap-4 md:gap-0">
        ...
        <button className="lg:px-3 px-2 lg:py-[10px] py-2 text-base font-medium flex gap-2 justify-between md:items-center outline-none rounded-lg border border-borderColorLight ">
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        <div className="border cursor-pointer bg-white p-5 rounded-xl border-borderColorLight">
