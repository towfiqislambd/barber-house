...
const ScheduledShifts = () => {
  ...
  return (
    <div>
      <h3 className="text-[#2C2C2C] font-outfit text-2xl font-medium mb-5">
        Scheduled shifts
      </h3>
      {/* Upper part */}
      <div className="flex justify-between items-center flex-wrap gap-3 lg:gap-5">
        <div className="flex gap-4 lg:gap-7 items-center flex-wrap">
          ...
          <Popover>
            <PopoverTrigger>
              <button className="px-4 py-[10px] flex gap-2 items-center outline-none rounded-lg border border-borderColorLight">
                <p>Options</p>
                <DropdownSvg />
              </button>
            </PopoverTrigger>
          ...
          <Link to="/businessDashboard/add-team-member">
            <button className="bg-[#0D1619] text-white px-5 py-[10px] rounded-lg font-medium">
              Add
            </button>
          </Link>
        </div>
        ...
        <table className="w-full border-collapse text-left min-w-[800px]">
          ...
          <tbody>
            {tableData.map(data => (
              <tr
                key={data.id}
                className="text-left border-t first:border-none border-dashed text-[#545454] text-nowrap"
              >
                ...
                <td className="px-4 border text-[#545454] font-medium py-2">
                  <p className="bg-[#E7E8FF] text-center py-1 rounded">
                    {data.dayOne}
                  </p>
                </td>
                <td className="px-4 border text-[#545454] font-medium py-2">
