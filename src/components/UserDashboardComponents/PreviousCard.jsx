...
export default function PreviousCard(props) {
    const { id, day, date, time, title, subTitle, price } = props.previousData;
            ...
            <div className='mb-[20px]' key={id}>
                <div className='p-[20px] flex gap-[10px] items-center rounded-[16px] bg-[#FFF] border border-[#DFE1E6] w-[100%] '>
                    ...
                    <div className='w-[10%] text-right relative'>
                        ...
                        <div className={`absolute w-[250px] shadow-md bg-white p-[32px] z-10 ${open ? "block" : "hidden"}`}>
