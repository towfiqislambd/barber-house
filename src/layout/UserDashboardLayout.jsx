          ...
          <div className="relative ">
            ...
            >
              ...
              <button
                ...
                className="absolute block xl:hidden text-red-600 top-[3px] right-[3px] text-[30px] z-10"
              >
                <LiaTimesCircle />
              </button>
            </div>
            ...
            <div>
              <button
                ...
                className="absolute top-[88px] text-[24px] z-0 bg-primary text-white py-[2px] px-[3px] rounded-tr-[5px] rounded-br-[5px] xl:hidden block"
              >
