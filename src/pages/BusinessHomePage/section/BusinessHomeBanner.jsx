  ...
  return (
    <section className="container flex flex-col xl:flex-row gap-[20px] items-center sm:pt-12 pb-[88px]">
      ...
      <div className="xl:w-1/2 space-y-6">
        <h1 className="text-[#1E1E1E] text-[28px] xl:text-4xl 2xl:text-5xl font-outfit font-semibold  2xl:leading-[57.6px] xl:max-w-[538px]">
          {data?.banner?.title}
        </h1>
        <p className="text-[#545454] font-manrope text-[18px] 2xl:text-2xl xl:leading-9 xl:max-w-[538px]">
