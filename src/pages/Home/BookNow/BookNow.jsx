    ...
    <section className="pt-[136px] container lg:px-5 xl:px-7 2xl:px-10 3xl:px-12 4xl:px-0">
      <div className="max-w-[640px] mx-auto">
        ...
        <div>
          ...
          <Link
            to="/select-service"
            state={{ bookingType: "single", storeData: storeData }}
          >
            <div className="bg-primaryLight rounded-2xl border-primary border py-5 md:py-7 xl:py-[40px] px-5 md:px-10 xl:px-[80px] mt-7 cursor-pointer">
              <h1 className="text-[#000] font-manrope text-lg md:text-xl font-semibold">
                Book a single appointment
              </h1>
              <p className="text-[#000] font-manrope text-base font-medium">
          ...
          <Link
            to="/select-service"
            state={{ bookingType: "group", storeData: storeData }}
          >
            <div className="bg-primaryLight rounded-2xl border-primary border py-5 md:py-7 xl:py-[40px] px-5 md:px-10 xl:px-[80px] mt-5 cursor-pointer">
              <h1 className="text-[#000] font-manrope text-lg md:text-xl font-semibold">
