  ...
  return (
    <section className="flex justify-center items-center h-screen text-center flex-col gap-5 relative">
      <div className="z-50 flex flex-col justify-center items-center">
        <CheckSvg />
        <h3 className="font-outfit mb-5 text-2xl lg:text-3xl font-semibold text-[#2C2C2C]">
          Appointment Successfully Completed
        </h3>
        <Link to="/">
          <button className="font-semibold text-lg text-primary px-3 lg:px-5 py-2 lg:py-3 rounded-lg border border-borderColor ">
            Back to home
          </button>
        </Link>
      </div>
