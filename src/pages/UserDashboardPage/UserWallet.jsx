    ...
    <>
      <div>
        ...
        <div className='pt-[50px] py-[15px] xl:py-[48px] px-[15px] xl:px-[56px]'>
          <div className='xl:w-[556px]'>
            <div className=' py-[15px] xl:py-[24px] px-[15px] xl:px-[32px] rounded-[16px]  bg-primary-gradient mb-[20px]'>
            ...
            <div className='py-[24px] px-[32px] border border-[#DFE1E6] rounded-[16px]'>
              <h3 className='mb-[20px] text-primary font-outfit text-[24px] font-medium leading-[28px]'>Cards</h3>
      ...
      >
        <div className='xl:p-[20px]'>
          ...
          <form action="">
            <input type="text" className='py-[14px] px-[20px] font-manrope text-[18px] font-medium w-full border border-[#d4d4d4] rounded-[8px] focus:border-primary focus:outline-none' placeholder='Write your gift card code' />
          </form>
          <button className='mt-[20px] xl:mt-[48px] py-[12px] xl:py-[14px] px-[20px] text-[#FFF] bg-primary-gradient rounded-[48px]  w-[100%] block font-manrope font-medium text-[18px]' onClick={() => setOpen(false)}>Confirm</button>
        </div>
      </Modal>
          ...
          <form action="">
            <div className='flex flex-col gap-[15px] xl:gap-[28px]'>
              <div>
                ...
                <input type="text" className='py-[14px] px-[20px] font-manrope text-[18px] font-medium w-full border border-[#d4d4d4] focus:border-primary focus:outline-none rounded-[8px]' placeholder='Write your gift card code' />
              </div>
              <div>
                <label className='text-[#2C2C2C] block text-[18px] font-semibold font-manrope leading-[27px] mb-[8px]' htmlFor="">Card number*</label>
                <div className='relative'>
                  <input type="number" className='py-[14px] px-[20px] font-manrope text-[18px] font-medium w-full border border-[#d4d4d4] focus:border-primary focus:outline-none rounded-[8px]' placeholder='Credit or debit card number' />
              ...
              <div className='flex flex-col gap-[20px]'>
                <div>
                  ...
                  <input type="text" className='py-[14px] px-[20px] font-manrope text-[18px] font-medium w-full border border-[#d4d4d4] rounded-[8px] focus:border-primary focus:outline-none' placeholder='MM/YY' />
                </div>
                <div>
                  <label className='text-[#2C2C2C] block text-[18px] font-semibold font-manrope leading-[27px] mb-[8px]' htmlFor="">Security code*</label>
                  <input type="text" className='py-[14px] px-[20px] font-manrope text-[18px] font-medium w-full border border-[#d4d4d4] rounded-[8px] focus:border-primary focus:outline-none' placeholder='123' />
                </div>
              </div>
            ...
            <div className='flex gap-[20px]'>
              ...
              <button className='py-[10px] xl:py-[14px] px-[20px] text-[#FFF] bg-primary-gradient rounded-[8px]  w-[100%] block font-manrope font-medium text-[18px]' onClick={() => setCardOpen(false)}>Save</button>
            </div>
