...
export default function UserMembershipCheckout() {
    return (
        <div>
            <Link to="/userdashboard/usermembership"> <button className='text-[25px] mb-[30px]'><FaArrowLeftLong /></button></Link>

            <h3 className='text-[#2C2C2C] font-outfit text-[36px] font-medium mb-[40px]'>Review and Checkout </h3>
            <div className='flex gap-[30px]'>
                <div className='flex-shrink-0 w-[814px]'>
                    <div className="border-[#B0ECEF] border rounded-[16px] py-[80px] px-[100px]">
                        <div className='mb-[40px]'>
                            <h3 className='mb-[8px] text-[#1E1E1E] font-outfit text-[28px] font-medium leading-[33px]'>Payment Process</h3>
                            <p className='text-[#545454] font-manrope text-[18px font-medium] leading-[27px]'>Your card will be charged straight away</p>
                        </div>
                        <div>
                            <form action="">
                                <div className='flex flex-col gap-[28px]'>
                                    <div>
                                        <label className='text-[#2C2C2C] block text-[18px] font-semibold font-manrope leading-[27px] mb-[8px]' htmlFor="">Card holder name*</label>
                                    ...
                                    <div className='flex gap-[20px]'>
                                        <div className='w-[50%]'>
                                            <label className='text-[#2C2C2C] block text-[18px] font-semibold font-manrope leading-[27px] mb-[8px]' htmlFor="">Expiry date*</label>
                        ...
                        <div>
                            <h3 className='mb-[40px] text-[#1E1E1E] font-outfit text-[24px] font-medium leading-[28px]'>Recipient details</h3>
                            <div className='flex flex-col gap-[28px]'>
                                <div className='flex'>
                                    <div className='w-[300px] flex-shrink-0'>
                                        <p className='text-[#2C2C2C] font-manrope text-[18px] font-medium'>Sender name</p>
                                    </div>
                                    <div>
                                        <p className='text-[#545454] font-manrope text-[18px] font-medium'>Tariqul Islam Fahim</p>
                                    </div>
                                </div>
                                <div className='flex'>
                                    <div className='w-[300px] flex-shrink-0'>
                                        <p className='text-[#2C2C2C] font-manrope text-[18px] font-medium'>Recipient name</p>
                                    </div>
                                    <div>
                                        <p className='text-[#545454] font-manrope text-[18px] font-medium'>Shafiqul Islam</p>
                                    </div>
                                </div>
                                <div className='flex'>
                                    <div className='w-[300px] flex-shrink-0'>
                                        <p className='text-[#2C2C2C] font-manrope text-[18px] font-medium'>Recipient email address</p>
                                    </div>
                                    <div>
                                        <p className='text-[#545454] font-manrope text-[18px] font-medium'>tariqulFahim97@gmail.com</p>
                                    </div>
                                </div>
                                <div className='flex'>
                                    <div className='w-[300px] flex-shrink-0'>
                                        <p className='text-[#2C2C2C] font-manrope text-[18px] font-medium'>Personal message</p>
                                    </div>
                                    <div>
                                        <p className='text-[#545454] font-manrope text-[18px] font-medium'>It’s a gift from me, daddy. May Allah bless you forever.</p>
                                    </div>
                                </div>
                                <div className='flex'>
                                    <div className='w-[300px] flex-shrink-0'>
                                        <p className='text-[#2C2C2C] font-manrope text-[18px] font-medium'>Send date</p>
                                    </div>
                                    <div>
                                        <p className='text-[#545454] font-manrope text-[18px] font-medium'>Today (Friday, 7 Feb 2025)</p>
                                    </div>
                                </div>
                ...
                <div className='flex-shrink-0 w-[400px] border border-[#B0ECEF] rounded-[16px] p-[30px] h-max'>
                    ...
                    <div className='flex flex-col gap-[64px]'>
                        ...
                        <div className='flex justify-between'>
                            <div>
                                <p className='mb-[5px] text-[#2C2C2C] font-manrope text-[20px] font-semibold'>Membership</p>
                                <p className='text-[#545454] font-manrope font-medium'>Valid for 4 months</p>
                            </div>
                        ...
                        <div>
                            <Link to="/userdashboard/membershipdone">
                                <button class="py-[14px] px-[20px] text-[#FFF] bg-gradient-to-r from-teal-600 to-cyan-500 rounded-[48px]  w-[100%] block font-manrope font-medium text-[18px]">Confirm</button>
                            </Link>
                        </div>
                    </div>
                </div>
