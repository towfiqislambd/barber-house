...
export default function GiftCard() {
  ...
  const linkStyle =
    "p-[24px] bg-[#F4F4F4] rounded-[8px] text-center w-full block font-manrope text-[#000] text-[18px]";
  return (
    <div>
      <h3 className="text-[#2C2C2C] font-outfit text-[36px] font-medium mb-[40px]">
        Choose an amount for gift cards
      </h3>
      <div className="flex gap-[30px]">
        <div className="flex-shrink-0 w-[814px]">
          <div>
            <ul className="flex flex-col gap-[20px] mb-[20px]">
              <li>
                <Link
                  to="/userdashboard/choosepeoplegiftcard"
                  className={linkStyle}
                >
                  SAR 100
                </Link>
            ...
            <div>
              <button
                className={`mb-[20px] font-semibold ${linkStyle}`}
                onClick={CustomeAmount}
              >
                Or custom amount
              </button>
              {customAmount && (
                <div className="p-[20px] border rounded-[8px]">
                  <form action="">
                    <label htmlFor="" className="font-semibold mb-[20px] block">
                      Enter a custom gift card card amount between AED 50 and
                      AED 2,000
                    </label>
                    <input
                      type="text"
                      className="border w-full rounded-[8px] py-[20px] px-[20px] focus:border-primary focus:outline-none"
                      placeholder="AED : 125"
                    />
                  </form>
                  <Link to="/userdashboard/choosepeoplegiftcard">
                    <button class="mt-[48px] py-[14px] px-[20px] text-[#FFF] bg-primary-gradient rounded-[48px]  w-[100%] block font-manrope font-medium text-[18px]">
                      Continue
                    </button>
                  </Link>
                </div>
        ...
        <div className="flex-shrink-0 w-[400px] border border-borderColorLight rounded-[16px] p-[30px] h-max">
          ...
          <div className="flex flex-col gap-[64px]">
            ...
            <div className="border py-[30px] border-t-borderColor border-b-borderColorLight border-l-0 border-r-0">
