  ...
  return (
    <div className="px-40 py-10">
      <div className="flex justify-between items-center">
        <div>
          <h3 className="font-outfit text-3xl font-semibold">
            Set Shawal’s regular shifts
          </h3>
          <p className="text-black mt-1 font-medium text-base">
        ...
        <div className="flex gap-3 items-center">
          <Link to="/businessDashboard/members-list">
            <button className="text-[#545454] border font-medium border-borderColorLight rounded-lg px-8 py-2">
              Close
            </button>
          </Link>
