    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex justify-between items-center mb-5">
                <button type="button" onClick={handlePrevStep} className="cursor-pointer">
                    <LeftSideArrowSvg />
                </button>
            ...
            <div className="max-w-[578px] mx-auto">
                ...
                <div className="space-y-4">
                    {["It's just me", "2-5 people", "10-15 people", "15-25 people"].map((option, index) => (
                        <label key={index} className="block cursor-pointer">
                            ...
                            />
                            <p className="border py-4 px-5 font-medium border-[#797979] rounded-lg text-[#1E1E1E] peer-checked:border-blue-500 peer-checked:bg-blue-50">
                                {option}
                            </p>
                        </label>
                    ))}
