  ...
  return (
    <section className="py-10">
      <div className="container">
        <div className="flex 2xl:gap-14 justify-center items-center 2xl:mt-0">
          {/* Left Side */}
          <div className="mt-3 2xl:block hidden">
            ...
            <img
              className="mt-3 w-[750px] h-[800px] rounded-[32px] object-cover"
              src={loginImg}
            />
          </div>
          {/* Right Side */}
          <form
            ...
            className="w-[524px] hide-scrollbar"
          >
            ...
            <div className="space-y-[14px] mt-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  <h2 className="text-textSecondary font-outfit leading-[22.96px]">
                    I agree to the{" "}
